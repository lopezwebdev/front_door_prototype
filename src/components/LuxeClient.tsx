...
import {
  ...
  Globe, ShieldCheck, Calendar, Clock, Users, PawPrint,
...
function ScreenConfirm({ form }: { form: IntakeState }) {
  ...
  return (
    <div className="animate-scaleIn">
      ...
      <div className="mt-6">
        <h3 className="mb-1 text-center text-sm font-bold text-navy-900">Continue your Japan move-in plan</h3>
        <p className="mb-3 text-center text-xs text-navy-400">Optional services from trusted GoGaijin partners</p>
